...
<body>
  ...
  $obj6 = $_POST['obj6'];
	...
	$sql = "INSERT INTO build(idcamp, obj1, obj2, obj3, obj4, obj5, obj6) VALUES ('$nombre','$obj1','$obj2','$obj3','$obj4','$obj5','$obj6')";
	$resultado = $mysqli->query($sql);

	if ($resultado > 0) {
  header('Location: builds.php');    
  	} else {
		echo "<br><p class='alert alert-danger'>ERROR AL AGREGAR EL REGISTRO</p>";
	}
